...
export async function chat(data) {
  ...
  const res = await axios.post(`${N8N_URL}/webapp`, formData, {
    headers: {
      "x-type": xType,
    },
  });
...
export async function chatPlayground(data) {
  const conversationId = getConversationId();
 ...
 */
export function chatStream({ message, useTools = true, topK = 1073741824 }, onChunk) {
  const conversationId = getConversationId();
 ...
 */
export function chatStreamAudio({ message, useTools = true, topK = 1073741824 }, onChunk) {
  const conversationId = getConversationId();
 ...
 */
export function chatStreamAudioText({ message, useTools = true, topK = 1073741824 }, onChunk) {
  const conversationId = getConversationId();
...
export async function getDocuments() {
  const res = await axios.get(`${N8N_URL}/kb/list`);
  return res.data;
}
...
export async function getWAStatus() {
  const res = await axios.get("https://auto.lab.kediritechnopark.com/webhook/wa/status-device");
  return res.data;
}

export async function connectWA() {
  const res = await axios.post("https://auto.lab.kediritechnopark.com/webhook/wa/connect-device");
  return res.data;
}

export async function disconnectWA() {
  const res = await axios.delete("https://auto.lab.kediritechnopark.com/webhook/wa/disconnect-device");
  return res.data;
}

export async function checkWAActive() {
  const res = await axios.get("https://auto.lab.kediritechnopark.com/webhook/wa/check");
  return res.data;
}

export async function connectWAToggle() {
  const res = await axios.put("https://auto.lab.kediritechnopark.com/webhook/wa/connect");
  return res.data;
}

export async function disconnectWAToggle() {
  const res = await axios.put("https://auto.lab.kediritechnopark.com/webhook/wa/disconnect");
  return res.data;
}

export async function checkTGActive() {
  const res = await axios.get("https://auto.lab.kediritechnopark.com/webhook/tg/check");
  return res.data;
}

export async function connectTGToggle() {
  const res = await axios.put("https://auto.lab.kediritechnopark.com/webhook/tg/connect");
  return res.data;
}

export async function disconnectTGToggle() {
  const res = await axios.put("https://auto.lab.kediritechnopark.com/webhook/tg/disconnect");
  return res.data;
}

export async function checkWebActive() {
  const res = await axios.get("https://auto.lab.kediritechnopark.com/webhook/web/check");
  return res.data;
}

export async function connectWebToggle() {
  const res = await axios.put("https://auto.lab.kediritechnopark.com/webhook/web/connect");
  return res.data;
}

export async function disconnectWebToggle() {
  const res = await axios.put("https://auto.lab.kediritechnopark.com/webhook/web/disconnect");
  return res.data;
}

export async function disconnectWebApp() {
  const res = await axios.put("https://auto.lab.kediritechnopark.com/webhook/webapp/disconnect");
  return res.data;
}

export async function connectWebApp() {
  const res = await axios.put("https://auto.lab.kediritechnopark.com/webhook/webapp/connect");
  return res.data;
}

export async function checkWebAppStatus() {
  const res = await axios.get("https://auto.lab.kediritechnopark.com/webhook/webapp/check");
  return res.data;
}

export async function getReport1d() {
  const res = await axios.get("https://auto.lab.kediritechnopark.com/webhook/report/1d");
  return res.data;
...
export async function getReport7d() {
  const res = await axios.get("https://auto.lab.kediritechnopark.com/webhook/report/7d");
  return res.data;
...
export async function getReport30d() {
  const res = await axios.get("https://auto.lab.kediritechnopark.com/webhook/report/30d");
  return res.data;
}

export async function getTopTopics() {
  const res = await axios.get("https://auto.lab.kediritechnopark.com/webhook/topics");
  return res.data;
}

export async function getAgentProfile() {
  const res = await axios.get("https://auto.lab.kediritechnopark.com/webhook/agent-profile");
  return res.data;
}

export async function updateAgentProfile(data) {
  const res = await axios.put("https://auto.lab.kediritechnopark.com/webhook/agent-profile", data);
  return res.data;
}