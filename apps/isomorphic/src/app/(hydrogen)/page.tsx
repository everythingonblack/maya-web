...
import WelcomeBanner from '@/app/(hydrogen)/maya-cs/welcome-banner';
import PlatformAccess from '@/app/(hydrogen)/maya-cs/platform-access';
import FleetStatus from '@/app/(hydrogen)/maya-cs/fleet-status';
